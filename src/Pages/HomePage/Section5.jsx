...
const Section5 = () => {
    ...
    useGSAP(() => {
        ...
        const featureSubTitle = SplitText.create(".right .sub", {
            type: "chars"
        })

        const featureTitle = SplitText.create(".right .title", {
            type: "words"
        })
        ...
        <div className='section-5 feature bg-[#FEFBEC]'>
            <div className="container lg:flex justify-between gap-10 items-center px-4 py-10">
                ...
                <div className="right lg:w-1/2 h-full">
                    ...
                    <h1 className='text-[8vw] title leading-8 text-zinc-700 my-2 md:text-5xl md:leading-[1] font-medium h-full overflow-hidden '>Elevate  your skills <span className='text-green-400'>with</span> expert <span className='text-green-400'>coaching courses</span></h1>
